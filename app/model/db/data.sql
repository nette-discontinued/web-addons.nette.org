...
INSERT INTO `addons` (`id`, `name`, `composer_name`, `user_id`, `repository`, `short_description`, `description`, `demo`, `updated_at`) VALUES
...
INSERT INTO `addons_dependencies` (`id`, `addon_id`, `dependency_id`, `package_name`, `version`, `type`) VALUES
...
INSERT INTO `addons_versions` (`id`, `addon_id`, `version`, `license`, `composer_json`) VALUES
(1,	1,	'2.0',	'',	NULL),
(2,	1,	'1.7',	'',	NULL),
(3,	2,	'1.0',	'',	NULL),
(4,	1,	'2.0.1',	'GPL',	NULL),
...
INSERT INTO `addons_votes` (`addon_id`, `user_id`, `vote`, `comment`) VALUES
(1,	1,	1,	NULL);
